...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Pedido o1 = new Pedido(null, Instant.parse("2022-06-20T19:53:07Z"), u1, StatusPedido.AGUARDANDO_PAGAMENTO);
        Pedido o2 = new Pedido(null, Instant.parse("2022-07-21T03:42:10Z"), u2, StatusPedido.AGUARDANDO_PAGAMENTO);
        Pedido o3 = new Pedido(null, Instant.parse("2022-07-22T15:21:22Z"), u1, StatusPedido.PAGO);
